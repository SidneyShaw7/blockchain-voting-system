...
const RegistrationForm = () => {
  ...
  return (
    <section className="bg-white">
      ...
      <section className="relative flex h-32 items-end bg-gray-900 border-b-2 border-[#EFE7BC]">
        <img alt="" src="/src/images/vote_yellow4.png" className="absolute inset-0 h-full w-full object-cover opacity-80" />
      ...
      <main className="flex items-center justify-center px-8 py-8 sm:px-12 lg:col-span-7 lg:px-16 lg:py-12 xl:col-span-3">
        <div className="max-w-xl">
          <div className="relative -mt-16 block lg:-mt-20 ">
            <a className="inline-flex size-16 items-center justify-center rounded-full bg-white text-blue-600 sm:size-20 border-t-2 border-[#EFE7BC]" href="#">
              <span className="sr-only">Home</span>
            ...
            <h1 className="mt-2 text-1xl font-bold text-gray-900 sm:text-2xl md:text-3xl">Secure Voting System</h1>
          ...
          <FormProvider {...methods}>
            <form onSubmit={methods.handleSubmit(onSubmit)} className="mt-8 grid grid-cols-6 gap-6">
              ...
              <div className="col-span-6 sm:flex sm:items-center sm:gap-4">
                ...
                <SignInUpButton onClick={methods.handleSubmit(onSubmit)}>Create an account</SignInUpButton>
