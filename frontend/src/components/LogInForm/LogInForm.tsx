      ...
      <main className="flex items-center justify-center px-8 py-8 sm:px-12 lg:col-span-7 lg:px-16 lg:py-12 xl:col-span-7">
        <div className="max-w-xl lg:max-w-3xl">
          <div className="relative -mt-16 block lg:-mt-20">
            <a
              className="inline-flex size-16 items-center justify-center rounded-full bg-white text-blue-600 size-20 border-t-2 border-[#EFE7BC]"
              href="#"
            >
              <span className="sr-only">Home</span>
            ...
            <h1 className="mt-2 text-1xl font-bold text-gray-900 sm:text-2xl md:text-3xl lg:pt-16 sm:pt-10">Login to Secure Voting System</h1>
