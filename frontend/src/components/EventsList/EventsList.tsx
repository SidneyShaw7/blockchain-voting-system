      ...
      <table className="min-w-full divide-y-2 divide-gray-200 bg-white text-sm">
        <thead className="ltr:text-left rtl:text-right">
          <tr>
            ...
            <th className="whitespace-nowrap px-4 py-2 font-medium text-gray-900">Event Date</th>
            <th className="whitespace-nowrap px-4 py-2 font-medium text-gray-900">Participation Status</th>
            <th className="whitespace-nowrap px-4 py-2 font-medium text-gray-900">Event Type</th>
            <th className="whitespace-nowrap px-4 py-2 font-medium text-gray-900">Your Role</th>
